            ...
            <div class="container"style="margin-top:60px;margin-left:260px;">
                ...
                <div class="row" >
                     ...
                     <div  style="margin-top:10px; margin-left:0px; ">
                        <div class="card" style="width:1300px;height:2000px;">
                            <div class="card-header" >
                          	
                          		<div style="width:140px;height:-4px;margin-top:-80px;" >
                          		<img src="<%="profile/" + CurrentUserInfo.getEmail() + ".jpg"%>"
										style="width: 175px; height: 175px; ">
                          		
                          		 <button type="button" class="btn btn-rounded btn-success"
                          		 style="margin-top:270px;margin-left:-160px;"><span class="btn-icon-left text-success"><i
                                                class="fa fa-upload color-success"></i> </span>Upload</button>
               				   </div>
