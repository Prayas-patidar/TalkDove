...
//                                                path=path+"downloaded";
        ...
        <div class="content-body">
            ...
            <div class="container"style="margin-top:60px;">
                ...
                <div class="row">
                     ...
                     <div class="col-xl-12 col-xxl-12" style="margin-top:10px; margin-left:0px; ">
                        ...
                        <div class="card" >
                            ...
                            <div style="float:left; text-align:right;width:20%">
                            		<img src="<%="profile/"+CheckProfile.getProfilename()+".jpg"%>" style="width:175px; height:175px;border-radius:500px;">
                            ...
                            <div style="float:right; width:60%">
                                	<div class="row" style="padding-left:60px;">
 									...
 									<div class="media pt-3" style="text-align:left; width:100%">
                                                   ...
                                                   Connection con= DBConnection.getConnection();
                                                   Statement st = con.createStatement();
                                                   ResultSet rs =  st.executeQuery("select dateofbirth from register where email = '"+CheckProfile.getProfilename()+"'");
                                                  Date d=null;
                                                   if(rs.next()){
                                                	  d= rs.getDate("dateofbirth");
                                                  }
                                                   %>
                                                        <h4 class="text-primary"><%= ""+CheckProfile.getProfilename()+""%></h4>
                                                        <p class="" style="font-size:10px; margin-top:-5px; height:10px; font-weight:450 ; color:#A5A7AB	;"><%= d %></p>
                 ...
                 String sqlq= "select status from follow where accepter= '"+CurrentUserInfo.getEmail()+"' and sender = '"+CheckProfile.getProfilename()+"'";
 ...
 %>
                 ...
                 <% 
                 String sql= "select status from follow where sender= '"+CurrentUserInfo.getEmail()+"' and accepter = '"+CheckProfile.getProfilename()+"'";
              ...
              <% if(!CurrentUserInfo.getEmail().equals(CheckProfile.getProfilename())){ %>
               <form action="follow">
               <input type="hidden" name="sender" value= "<%= CurrentUserInfo.getEmail()%>">
               		<input type="hidden" name="accepter" value= "<%= CheckProfile.getProfilename()%>">
               
                  <% if(status.equals("follow")) {%> <button type= "submit" class="bg-primary text-light" style=" font-weight: 25px; margin-top:-5px; border-radius:10px; padding-left:25px;
                                        padding-right:25px;
                                        padding-top:5px;
                                        padding-bottom:5px;
                                      font-size:20px;
                                         margin-left:5px;"> <i class="fa fa-user-plus"  aria-hidden="true">   </i><span class="card-text" style=" font-size: 15px;"><b>&ensp; Follow</b></span>    </button>
                  <% } else if(status.equals("pending")){ %><button type= "submit" class="bg-dark text-light" style=" font-weight: 25px; margin-top:-5px; border-radius:10px; padding-left:15px;
                                        padding-right:15px;
                                        padding-top:5px;
                                        padding-bottom:5px;
                                      font-size:20px;
                                         margin-left:5px;">&ensp;<i class="mdi mdi-account-alert"  aria-hidden="true"></i><span class="card-text" style=" font-size: 15px;"><b>&nbsp;&ensp;Requested&ensp;&nbsp;</b></span>    </button>
                  <% } else if(status.equals("accepted")){ %><button type= "submit" class="bg-primary text-light" style=" font-weight: 25px; margin-top:-5px; border-radius:10px; padding-left:15px;
                                        padding-right:15px;
                                        padding-top:5px;
                                        padding-bottom:5px;
                                      font-size:20px;
                                         margin-left:5px;"><span class="card-text" style=" font-size: 15px;"><b>&ensp; Following &ensp;</b></span>    </button> <% } %>
                ...
                <div class="row" >
                    ...
                    <%try{
                                         // dp laani h yaha pr
                                            Connection con = DBConnection.getConnection();
                                            Statement st = con.createStatement();
                                            System.out.println("Select * from "+CheckProfile.getProfilename()+"post where status = 1 order by time DESC");
                                            ResultSet rs = st.executeQuery("Select * from "+CheckProfile.getProfilename()+"post where status = 1 order by time DESC");
                    ...
                    <div class="col-xl-4 col-xxl-6 col-lg-6 col-sm-6" style="width:70%;height:40%;">
                        ...
                        <input type="hidden" value="<%=rs.getString("postid")%>" name="postid" />
                           ...
                           <div class="card-header">
                                ...
                                <img src="profile/<%=user+".jpg"%>" style="
                                border-radius:100px;
                                width:45px;
                                height:45px;
                               ">
                                </div>
                                <div style="float:right; text-align:left; margin-left:0px; width:50%;">
