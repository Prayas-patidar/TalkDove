...
<html lang="en">
<head>
	<title>Talkdove - Forgot Password</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form action="changepassword" method="post" class="login100-form validate-form">
					<span class="login100-form-title">
						<img src="images/talkdove.png" alt="IMG" style="width:200px; background-color:white;">
					</span>
			<% if(forgetPassword.getEmail().equals("")){ %>
				...
				<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<input class="input100" type="text"  value="<%= forgetPassword.getEmail() %>" readonly>
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
