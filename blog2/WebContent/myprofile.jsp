...
<title>Talkdove - <%= CurrentUserInfo.getUsername() %></title>
				...
				<nav class="navbar navbar-expand">
					<div class="collapse navbar-collapse justify-content-between">
						...
						<div class="hs">
							...
							<div class="showcase">
						<%		
							String checkfollower1 = "select * from follow where sender ='"+CurrentUserInfo.getEmail()+"' and status='accepted'";      
                    		ArrayList<String> follower1 = new  ArrayList<String>();		
                   			 try{
                    			Connection con = DBConnection.getConnection();
                    			Statement sst = con.createStatement();
                    			ResultSet rsfollow = sst.executeQuery(checkfollower1);
                    			while(rsfollow.next()){
                    				follower1.add(rsfollow.getString("accepter"));
                    			}
                    		}catch(Exception ee){
                    			System.out.println(ee);
									...
									while (rsst.next()) {
										...
										if(!(follower1.contains(rsst.getString("user"))||CurrentUserInfo.getEmail().equals(rsst.getString("user"))))
											continue;
													...
													<li class="nav-item dropdown notification_dropdown"><a
															...
															<ul class="list-unstyled">
																...
																<li class="media ">
																	<div class="media-body" style="height:50px;">
																		<%
																        String checkfollower = "select * from follow where accepter ='"+CurrentUserInfo.getEmail()+"' and status='accepted'";      
											                    ...
											                    String checkfollowing= "select * from follow where sender ='"+CurrentUserInfo.getEmail()+"' and status='accepted'";      
									                    ...
									                    try{
									                    			...
									                    			System.out.println(ee);
																		...
																		%>
																		...
																		</h5><br><h5 style="margin-top:30px;margin-left:-55px;"><span class="badge badge-primary"><%= follower.size()%></span></h5>
																			...
																			<div class="d-flex justify-content-between" style="float:right;">
																				...
																				<div style="margin-bottom:10px;"><h5 style="margin-top:30px;margin-right:12px;margin-left:-20px;"><span class="badge badge-primary"><%= following.size() %></span></h5>
